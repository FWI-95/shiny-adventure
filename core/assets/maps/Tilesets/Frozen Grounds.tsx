...
<tileset name="Frozen Grounds" tilewidth="48" tileheight="48" tilecount="256" columns="16">
 <image source="../Images/Frozen Grounds.png" trans="ff01fe" width="768" height="768"/>
 <terraintypes>
